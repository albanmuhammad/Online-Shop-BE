                ...
                <form class="w-full" action="{{route('dashboard.product.gallery.store', $product->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            <label class="block uppercase tracking-wide text-grey-700 text-xs font-bold mb-2" for="grid-last-name">
                                Files
                            </label>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3 text-right">
                            <button type="submit" class="shadow-lg bg-green-500 hover:bg-green-500  text-white font-bold py-2 px-4 rounded">
                                save gallery
                            </button>
                        </div>
                    </div>
